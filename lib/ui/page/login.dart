...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if(isgoogleLoading){Showloading();}
    return Scaffold(
            ...
            Container(
              ...
              child: Center(
                child: Form(
                  ...
                  child: Column(
                    children: [
                      MytextTilteblack(text: textLogin),
                      Padding(
                      ...
                      Mybuttons(
                        text: bottonLoginRegist, onpress: onsignup, bcg: botton , inloading:  loading ,),
                    MaterialButton(onPressed: (){
                      pushReplace(SigneUpScreen(), context);
                    }
                    ,child: Text(bottongotosigneup  ,
                        style:TextStyle(
                            fontSize: 16,
...
void Showloading(){
  ...
  void onsignup(){
    ...
    if ( formkey.currentState!.validate()){
      ...
      formkey.currentState!.save ();
      userData.login(email!, pass!).then((value)async {
        if (value == 1){
